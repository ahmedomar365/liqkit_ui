            ...
            nodes: const <LiqTreeNode<String>>[
              LiqTreeNode<String>(
                ...
                children: <LiqTreeNode<dynamic>>[
                  LiqTreeNode<String>(id: 'ch1/intro', label: '1.1 Overview'),
              ...
              LiqTreeNode<String>(
                ...
                label: '2. Foundations',
                children: <LiqTreeNode<dynamic>>[
                  LiqTreeNode<String>(id: 'ch2/colors', label: '2.1 Colors'),
                  LiqTreeNode<String>(
                    id: 'ch2/typography',
              ...
              LiqTreeNode<String>(
                ...
                label: '3. Components',
                children: <LiqTreeNode<dynamic>>[
                  LiqTreeNode<String>(id: 'ch3/buttons', label: '3.1 Buttons'),
