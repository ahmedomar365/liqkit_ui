...
export const SNIPPET_ROUTES = {
  ...
  'action-sheet/compact': { component: 'action-sheet', variant: 'compact', displayName: "Compact", path: '/action-sheet/compact' },
  'action-sheet/default': { component: 'action-sheet', variant: 'default', displayName: "Default", path: '/action-sheet/default' },
  'action-sheet/destructive': { component: 'action-sheet', variant: 'destructive', displayName: "Destructive", path: '/action-sheet/destructive' },
  'action-sheet/scrollable': { component: 'action-sheet', variant: 'scrollable', displayName: "Scrollable", path: '/action-sheet/scrollable' },
  'action-sheet/standard': { component: 'action-sheet', variant: 'standard', displayName: "Standard", path: '/action-sheet/standard' },
  ...
  'action-sheet/with-icons': { component: 'action-sheet', variant: 'with-icons', displayName: "With Icons", path: '/action-sheet/with-icons' },
  'action-sheet/with-title': { component: 'action-sheet', variant: 'with-title', displayName: "With Title", path: '/action-sheet/with-title' },
  ...
  'bar-chart/default': { component: 'bar-chart', variant: 'default', displayName: "Default", path: '/bar-chart/default' },
  'bar-chart/multi-color': { component: 'bar-chart', variant: 'multi-color', displayName: "Multi-color", path: '/bar-chart/multi-color' },
  ...
  'carousel/autoplay': { component: 'carousel', variant: 'autoplay', displayName: "Autoplay", path: '/carousel/autoplay' },
  'carousel/default': { component: 'carousel', variant: 'default', displayName: "Default", path: '/carousel/default' },
  'carousel/no-indicator': { component: 'carousel', variant: 'no-indicator', displayName: "No indicator", path: '/carousel/no-indicator' },
  ...
  'drawer/collapsed': { component: 'drawer', variant: 'collapsed', displayName: "Collapsed", path: '/drawer/collapsed' },
  ...
  'face-id/bezel-states': { component: 'face-id', variant: 'bezel-states', displayName: "Bezel States", path: '/face-id/bezel-states' },
  'face-id/fail': { component: 'face-id', variant: 'fail', displayName: "Fail", path: '/face-id/fail' },
  'face-id/inline': { component: 'face-id', variant: 'inline', displayName: "Inline", path: '/face-id/inline' },
  ...
  'face-id/theme-colors': { component: 'face-id', variant: 'theme-colors', displayName: "Theme Colors", path: '/face-id/theme-colors' },
  'face-id/touch-id': { component: 'face-id', variant: 'touch-id', displayName: "Touch ID", path: '/face-id/touch-id' },
  'glass-surface/dark': { component: 'glass-surface', variant: 'dark', displayName: "Dark", path: '/glass-surface/dark' },
  'glass-surface/flat': { component: 'glass-surface', variant: 'flat', displayName: "Flat", path: '/glass-surface/flat' },
  'glass-surface/floating': { component: 'glass-surface', variant: 'floating', displayName: "Floating", path: '/glass-surface/floating' },
  ...
  'line-chart/default': { component: 'line-chart', variant: 'default', displayName: "Default", path: '/line-chart/default' },
  'line-chart/dots': { component: 'line-chart', variant: 'dots', displayName: "With dots", path: '/line-chart/dots' },
  'line-chart/sparkline': { component: 'line-chart', variant: 'sparkline', displayName: "Sparkline", path: '/line-chart/sparkline' },
  ...
  'materials/all-styles': { component: 'materials', variant: 'all-styles', displayName: "All Material Styles", path: '/materials/all-styles' },
  'materials/custom-config': { component: 'materials', variant: 'custom-config', displayName: "Custom Configuration", path: '/materials/custom-config' },
  ...
  'materials/vibrancy-off': { component: 'materials', variant: 'vibrancy-off', displayName: "Vibrancy Off", path: '/materials/vibrancy-off' },
  'menu/context': { component: 'menu', variant: 'context', displayName: "Context", path: '/menu/context' },
  'menu/default': { component: 'menu', variant: 'default', displayName: "Default", path: '/menu/default' },
  'menu/dropdown': { component: 'menu', variant: 'dropdown', displayName: "Dropdown", path: '/menu/dropdown' },
  'menu/inline': { component: 'menu', variant: 'inline', displayName: "Inline", path: '/menu/inline' },
  'menu/menu-bar': { component: 'menu', variant: 'menu-bar', displayName: "Menu Bar", path: '/menu/menu-bar' },
  ...
  'picker/date-range': { component: 'picker', variant: 'date-range', displayName: "Date Range", path: '/picker/date-range' },
  'picker/inline-calendar': { component: 'picker', variant: 'inline-calendar', displayName: "Inline Calendar", path: '/picker/inline-calendar' },
  'picker/measurement': { component: 'picker', variant: 'measurement', displayName: "Measurement", path: '/picker/measurement' },
  'picker/multi-column': { component: 'picker', variant: 'multi-column', displayName: "Multi Column", path: '/picker/multi-column' },
  'picker/number': { component: 'picker', variant: 'number', displayName: "Number", path: '/picker/number' },
  'picker/single-column': { component: 'picker', variant: 'single-column', displayName: "Single Column", path: '/picker/single-column' },
  'picker/timer-hm': { component: 'picker', variant: 'timer-hm', displayName: "Timer — H/M", path: '/picker/timer-hm' },
  'picker/timer-hms': { component: 'picker', variant: 'timer-hms', displayName: "Timer — H/M/S", path: '/picker/timer-hms' },
  'picker/timer-interval': { component: 'picker', variant: 'timer-interval', displayName: "Timer — Custom Minute Interval", path: '/picker/timer-interval' },
  'picker/timer-ms': { component: 'picker', variant: 'timer-ms', displayName: "Timer — M/S", path: '/picker/timer-ms' },
  'picker/trigger-buttons': { component: 'picker', variant: 'trigger-buttons', displayName: "Date / Time / Date+Time Triggers", path: '/picker/trigger-buttons' },
  'picker/wheel-date': { component: 'picker', variant: 'wheel-date', displayName: "Wheel — Date", path: '/picker/wheel-date' },
  'picker/wheel-date-time': { component: 'picker', variant: 'wheel-date-time', displayName: "Wheel — Date & Time", path: '/picker/wheel-date-time' },
  'picker/wheel-month-year': { component: 'picker', variant: 'wheel-month-year', displayName: "Wheel — Month + Year", path: '/picker/wheel-month-year' },
  'picker/wheel-time': { component: 'picker', variant: 'wheel-time', displayName: "Wheel — Time", path: '/picker/wheel-time' },
  'picker/wheel-time-24h': { component: 'picker', variant: 'wheel-time-24h', displayName: "Wheel — 24-Hour", path: '/picker/wheel-time-24h' },
  ...
  'popup-button/common-use-cases': { component: 'popup-button', variant: 'common-use-cases', displayName: "Common Use Cases", path: '/popup-button/common-use-cases' },
  'popup-button/large': { component: 'popup-button', variant: 'large', displayName: "Large", path: '/popup-button/large' },
  'popup-button/popup-disabled': { component: 'popup-button', variant: 'popup-disabled', displayName: "Popup — Disabled", path: '/popup-button/popup-disabled' },
  'popup-button/popup-full-width': { component: 'popup-button', variant: 'popup-full-width', displayName: "Popup — Full Width", path: '/popup-button/popup-full-width' },
  'popup-button/popup-pre-selected': { component: 'popup-button', variant: 'popup-pre-selected', displayName: "Popup — Pre-Selected", path: '/popup-button/popup-pre-selected' },
  'popup-button/popup-sizes': { component: 'popup-button', variant: 'popup-sizes', displayName: "Popup — Sizes", path: '/popup-button/popup-sizes' },
  'popup-button/popup-styles': { component: 'popup-button', variant: 'popup-styles', displayName: "Popup — Styles", path: '/popup-button/popup-styles' },
  'popup-button/popup-with-icons': { component: 'popup-button', variant: 'popup-with-icons', displayName: "Popup — With Item Icons", path: '/popup-button/popup-with-icons' },
  'popup-button/popup-without-icons': { component: 'popup-button', variant: 'popup-without-icons', displayName: "Popup — Without Icons", path: '/popup-button/popup-without-icons' },
  'popup-button/pulldown-disabled': { component: 'popup-button', variant: 'pulldown-disabled', displayName: "Pull Down — Disabled", path: '/popup-button/pulldown-disabled' },
  'popup-button/pulldown-full-width': { component: 'popup-button', variant: 'pulldown-full-width', displayName: "Pull Down — Full Width", path: '/popup-button/pulldown-full-width' },
  'popup-button/pulldown-sizes': { component: 'popup-button', variant: 'pulldown-sizes', displayName: "Pull Down — Sizes", path: '/popup-button/pulldown-sizes' },
  'popup-button/pulldown-styles': { component: 'popup-button', variant: 'pulldown-styles', displayName: "Pull Down — Styles", path: '/popup-button/pulldown-styles' },
  'popup-button/pulldown-with-leading': { component: 'popup-button', variant: 'pulldown-with-leading', displayName: "Pull Down — Leading Icon", path: '/popup-button/pulldown-with-leading' },
  'popup-button/pulldown-without-icon': { component: 'popup-button', variant: 'pulldown-without-icon', displayName: "Pull Down — No Icon", path: '/popup-button/pulldown-without-icon' },
  'popup-button/regular': { component: 'popup-button', variant: 'regular', displayName: "Regular", path: '/popup-button/regular' },
  'popup-button/split-disabled-primary': { component: 'popup-button', variant: 'split-disabled-primary', displayName: "Split — Disabled Primary", path: '/popup-button/split-disabled-primary' },
  'popup-button/split-sizes': { component: 'popup-button', variant: 'split-sizes', displayName: "Split — Sizes", path: '/popup-button/split-sizes' },
  'popup-button/split-styles': { component: 'popup-button', variant: 'split-styles', displayName: "Split — Styles", path: '/popup-button/split-styles' },
  'popup-button/split-with-leading': { component: 'popup-button', variant: 'split-with-leading', displayName: "Split — Leading Icon", path: '/popup-button/split-with-leading' },
  'popup-button/split-without-leading': { component: 'popup-button', variant: 'split-without-leading', displayName: "Split — No Leading Icon", path: '/popup-button/split-without-leading' },
  ...
  'textarea/default': { component: 'textarea', variant: 'default', displayName: "Default", path: '/textarea/default' },
  'textarea/with-counter': { component: 'textarea', variant: 'with-counter', displayName: "With counter", path: '/textarea/with-counter' },
